...
<section className="relative bg-bg-bluish-light py-32 md:py-48 flex flex-col items-center justify-center text-center overflow-hidden min-h-screen-75 pt-24 md:pt-32">
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {mockJobs.map((job) => (
        <div key={job.id} className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/30 flex flex-col justify-between transform hover:-translate-y-2 transition duration-300">
          ...
          <a
            // Use the new applicationLink from your mockJobs data
          ...
          >
            {/* Use job.buttonText if available, otherwise default to 'Apply Now' */}
...
>
  ...
  <div className="mb-6">
    <input
      type="text"
      name="name" // Important: The 'name' attribute identifies the field for Formspree
      ...
      required // Make this required, or remove if you want it optional
    />
  </div>

  <div className="mb-6"> {/* This div already exists for your email field */}
    <input
      type="email"
      name="email"
...
</form> {/* This closing form tag should be correct in your overall file */}
</div> {/* This closing div tag should be correct in your overall file */}
</section>
      ...
      <div className="mb-8 md:mb-0">
        ...
        <div className="flex space-x-5 mt-6">
          ...
          <a href="#" target="_blank" rel="noopener noreferrer" className="text-white hover:text-accent-teal transition-colors text-2xl" aria-label="Facebook">
            <i className="fab fa-facebook-f"></i> {/* UNCOMMENTED AND USED THIS */}
          </a>
          <a href="#" target="_blank" rel="noopener noreferrer" className="text-white hover:text-accent-teal transition-colors text-2xl" aria-label="Twitter">
            <i className="fab fa-twitter"></i> {/* UNCOMMENTED AND USED THIS */}
          </a>
          <a href="#" target="_blank" rel="noopener noreferrer" className="text-white hover:text-accent-teal transition-colors text-2xl" aria-label="LinkedIn">
            <i className="fab fa-linkedin-in"></i> {/* UNCOMMENTED AND USED THIS */}
          </a>
